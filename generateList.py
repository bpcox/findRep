...
houseduplicates = ['Collins', 'Rice', 'Green', 'Thompson', 'Ryan', 'Kelly',
'Wilson', 'Smith', 'Brooks', 'Rogers', 'Duncan', 'Maloney', 'Price', 'Murphy',
'Heck', 'Graves', 'Jenkins', 'King', 'Johnson', 'Carter', 'Miller', 'Bishop',
'Brady', 'Davis', 'Young', 'Scott']

bothduplicates =  ['Brown', 'Collins', 'Rice', 'Reed', 'Green', 'Thompson',
'Ryan', 'Kelly', 'Wilson', 'Smith', 'Brooks', 'Rogers', 'Duncan', 'Maloney',
'Price', 'Murphy', 'Bishop', 'Heck', 'Graves', 'Jenkins', 'King', 'Johnson',
'Graham', 'Peters', 'Carter', 'Miller', 'Lee', 'Brady', 'Davis', 'Young',
'Sessions', 'Scott']
