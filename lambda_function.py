...
def on_intent(intent_request, session):
    ...
    if intent_name == "FindRep":
        return find_representatives(intent)
...
def get_representatives(intent):
    card_title = intent['zip']
    should_end_session = True
    session_attributes = {}
    
	congressmen = sunlight.Congress.locate_legislators_by_zip(intent['zip'])
    ...
    if congressmen:
		...
		if len(senators) is 2:
			senators_string = "Your senators are " + senators[0]['first_name'] + ' ' \
			senators[0]['last_name'] + " and " + senators[1]['first_name'] + ' ' + senators[1]['last_name'] + '. '
    ...
    reprompt_text = "Sorry, I didn't understand that. Please provide your zip code"                       
